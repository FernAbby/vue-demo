<template>
  <div class="district-search-page">
    <div id="container"></div>
    <template v-if="loadComplete">
      <CascaderPlugin :map="map" />
      <DownloadPlugin />
    </template>
  </div>
</template>
<script lang="ts" setup>
  ...
  import CascaderPlugin from './CascaderPlugin.vue'
  import DownloadPlugin from './DownloadPlugin.vue'
  import { mapLoader } from '@/views/tools/map/utils/common'
  const loadComplete = ref(false)
  const map = ref()

  function createMap() {
    mapLoader(['AMap.DistrictSearch']).then((AMap) => {
      // 创建地图实例
